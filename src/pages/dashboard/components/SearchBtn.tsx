...
const SearchBtn = ({ setSearch, refetch }: {setSearch:  React.Dispatch<React.SetStateAction<string>>; refetch: () => void}) => {
  ...
  return (
    <div className="relative h-12 w-full">
      ...
      <Input
        ...
        className="pl-12 pr-3 py-2 text-md h-12 bg-gray-50 font-medium"
        value={input}
